...
from bot.constants.constants import BIRTHDAYGRAM_LOG_NAME, BOT_TIMEZONE, TOKEN
...
from bot.handlers.main_handlers import (error_handler, menu_handler,
                                        start_handler, text_handler)
